...
def _get_authorization_url(secret_config, app_url):
    flow = google_auth_oauthlib.flow.Flow.from_client_config(
        secret_config,  # replace with you json credentials from your google auth app
        scopes=[
            "openid",
...
def _login(
    ...
    _check_authentification(
        secret_config, cookie_name, cookie_key, cookie_expiry_days, app_url
    )

    authorization_url = _get_authorization_url(secret_config, app_url)

...
def login(
    ...
    secret_config: dict = 'authentification/google_credentials.json'
...
def get_authorization_url(secret_config: dict, app_url: str) -> str:
    """
    ...
    app_url: str = 'http://localhost:8501'
        URL of the app to redirect to after authentication"""
    return _get_authorization_url(secret_config, app_url)
...
def check_authentification(
    ...
    _check_authentification(
        secret_credentials_path, cookie_name, cookie_key, cookie_expiry_days, app_url
    )

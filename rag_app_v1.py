...
app_url = "https://ngenux-rag-aws.streamlit.app"
color = "blue"  # Or 'white'
justify_content = "center"


st.markdown(
    "<h1 style='text-align: center;'>Ngenux RAG ChatBot</h1>", unsafe_allow_html=True
)
...
if st.session_state["connected"]:
    ...
    def get_sessions(table_name):
        ...
        unique_session_ids = list(
            set(item["SessionId"]["S"] for item in response["Items"])
        )
